...
export default function Index({
  ...
  const [idKota, setIdKota] = React.useState(null);
  ...
  async function handlerDelete(e: any) {
    ...
    try {
      const request = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/kota/${idKota}`,
        {
          method: "DELETE",
          headers: {
  ...
  return (
    <>
      <Sidebar profile={profile}>
        <Table
          title="Kota"
          description="Management data kota pada aplikasi Yogi Travel."
          link="/admin/kota/add"
          data={data}
        >
                  ...
                  <tr key={kota.id}>
                    ...
                    <td className="min-w-max relative whitespace-nowrap py-4 text-sm font-medium sm:pr-6 flex gap-4">
                      ...
                      <button
                        ...
                        onClick={(e) =>
                          handlerDeleteModal(e, parseInt(kota.id))
                        }
                      >
                        Hapus
                      </button>
            ...
            >
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  >
                    Yakin ingin menghapus data Kota dengan id {idKota}
                  </DialogTitle>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Menghapus data membuat data kota yang sudah tersimpan
